...
from pyattest.exceptions import PyAttestException, InvalidNonceException, InvalidAppIdException, InvalidAppIntegrity, \
    InvalidDeviceIntegrity, InvalidKeyIdException, IllegalConfigurationException
...
def test_invalid_key_sideloaded():
    ...
    config = GooglePlayIntegrityApiConfig(decryption_key=base64.standard_b64encode(aes_key).decode(),
                                          ...
                                          production=True,
                                          allow_non_play_distribution=True,
                                          verify_code_signature_hex=["A0:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00"]
                                          )
...
def test_illegal_config1():
    apk_package_name = 'foo'
    _, verification_key, aes_key = get_play_integrity_api_attestation(apk_package_name, nonce,
                                                                      'UNRECOGNIZED_VERSION',
                                                                      ['MEETS_DEVICE_INTEGRITY'])
    with raises(IllegalConfigurationException):
        GooglePlayIntegrityApiConfig(decryption_key=base64.standard_b64encode(aes_key).decode(),
                                     verification_key=base64.standard_b64encode(
                                         verification_key.public_bytes(encoding=Encoding.DER,
                                                                       format=PublicFormat.SubjectPublicKeyInfo))
                                     .decode(),
